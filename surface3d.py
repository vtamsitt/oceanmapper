...
def surface3d(fig=None,mode,xdata,ydata,zdata,scalardata=None,vmin=None,vmax=None,data_cmap='blue-red',data_alpha=1,topo=None,topo_limits=None,zscale=500.,set_view=None):
    """
